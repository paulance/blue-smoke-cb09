...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/blue-smoke-cb09#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/blue-smoke-cb09
```

A live public deployment of this template is available at [https://blue-smoke-cb09.templates.workers.dev](https://blue-smoke-cb09.templates.workers.dev)
